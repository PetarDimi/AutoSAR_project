...
#define BswMConf_BswMRule_CC_CAN00_f26020e5_TX (4) 
#define BswMConf_BswMRule_CC_CAN00_f26020e5_RX_DM (3) 
#define BswMConf_BswMRule_CC_CAN00_f26020e5_RX (2) 
#define BswMConf_BswMRule_ESH_RunToPostRun (11) 
#define BswMConf_BswMRule_ESH_RunToPostRunNested (12) 
...
#define BswMConf_BswMRule_ESH_DemInit (5) 
#define BswMConf_BswMRule_ESH_InitToWakeup (6) 
#define BswMConf_BswMRule_ESH_PostRunToPrepNested (9) 
#define BswMConf_BswMRule_ESH_PostRunNested (8) 
#define BswMConf_BswMRule_ESH_PostRun (7) 
#define BswMConf_BswMRule_ESH_PrepToWait (10) 
#define BswMConf_BswMRule_BswmRule_BatteryLow (1) 
...
typedef struct sBswM_ActionListQueueStructTag
{
  ...
  BswM_ActionListQueueType AL_BswMActionList_BatteryLow_True[1];
