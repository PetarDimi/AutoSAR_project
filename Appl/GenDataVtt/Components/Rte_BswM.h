...
FUNC(uint8, RTE_CODE) Rte_Mode_BswM_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
#  define Rte_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode Rte_Mode_BswM_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode
