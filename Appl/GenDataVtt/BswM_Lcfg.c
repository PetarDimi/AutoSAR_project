 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: BswM_Lcfg.c
 *   Generation Time: 2023-03-12 17:03:41
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_BswMActionList_BatteryLow_True(void);
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_BswmRule_BatteryLow(void);
...
BSWM_LOCAL VAR(Rte_ModeType_MdgBswMBatteryMode, BSWM_VAR_NOINIT) BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode;
...
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[23] = {
  ...
  { /*    22 */ BswM_ActionList_BswMActionList_BatteryLow_True              }   /* [Priority: 0] */  /* [AL_BswMActionList_BatteryLow_True] */
};
...
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[17] = {
  ...
  { /*     1 */  4U, BSWM_FALSE    , BswM_Rule_CC_CAN00_f26020e5_TX    },  /* [R_CC_CAN00_f26020e5_TX, COMBINATION[MRP_CanSMInd_CAN00_f26020e5, MRP_CC_CanSMIndication_CAN00_f26020e5]] */
  { /*     2 */  3U, BSWM_FALSE    , BswM_Rule_CC_CAN00_f26020e5_RX_DM },  /* [R_CC_CAN00_f26020e5_RX_DM, COMBINATION[MRP_CanSMInd_CAN00_f26020e5, MRP_CC_CanSMIndication_CAN00_f26020e5]] */
  { /*     3 */  2U, BSWM_FALSE    , BswM_Rule_CC_CAN00_f26020e5_RX    },  /* [R_CC_CAN00_f26020e5_RX, COMBINATION[MRP_CanSMInd_CAN00_f26020e5, MRP_CC_CanSMIndication_CAN00_f26020e5]] */
  { /*     4 */ 11U, BSWM_FALSE    , BswM_Rule_ESH_RunToPostRun        },  /* [R_ESH_RunToPostRun, MRP_ESH_State, MRP_ESH_ComMIndication_CAN00_f26020e5, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer, MRP_ESH_ModeNotification] */
  { /*     5 */ 12U, BSWM_FALSE    , BswM_Rule_ESH_RunToPostRunNested  },  /* [R_ESH_RunToPostRunNested] */
  { /*     6 */ 13U, BSWM_FALSE    , BswM_Rule_ESH_WaitToShutdown      },  /* [R_ESH_WaitToShutdown, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_WriteAllTimer, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     7 */ 15U, BSWM_FALSE    , BswM_Rule_ESH_WakeupToPrep        },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
  { /*     8 */ 14U, BSWM_FALSE    , BswM_Rule_ESH_WaitToWakeup        },  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     9 */ 16U, BSWM_FALSE    , BswM_Rule_ESH_WakeupToRun         },  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_NvMIndication, MRP_ESH_NvM_CancelWriteAllTimer, MRP_ESH_ModeNotification] */
  { /*    10 */  5U, BSWM_FALSE    , BswM_Rule_ESH_DemInit             },  /* [R_ESH_DemInit] */
  { /*    11 */  6U, BSWM_FALSE    , BswM_Rule_ESH_InitToWakeup        },  /* [R_ESH_InitToWakeup, MRP_ESH_State] */
  { /*    12 */  9U, BSWM_FALSE    , BswM_Rule_ESH_PostRunToPrepNested },  /* [R_ESH_PostRunToPrepNested] */
  { /*    13 */  8U, BSWM_FALSE    , BswM_Rule_ESH_PostRunNested       },  /* [R_ESH_PostRunNested] */
  { /*    14 */  7U, BSWM_FALSE    , BswM_Rule_ESH_PostRun             },  /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_ModeNotification] */
  { /*    15 */ 10U, BSWM_FALSE    , BswM_Rule_ESH_PrepToWait          },  /* [R_ESH_PrepToWait, MRP_ESH_State, MRP_ESH_ModeNotification] */
  { /*    16 */  1U, BSWM_FALSE    , BswM_Rule_BswmRule_BatteryLow     }   /* [R_BswmRule_BatteryLow, MRP_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
...
VAR(uBswM_ActionListQueueType, BSWM_VAR_NOINIT) BswM_ActionListQueue;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*    22 */  /* [AL_BswMActionList_BatteryLow_True] */
...
VAR(BswM_RuleStatesType, BSWM_VAR_NOINIT) BswM_RuleStates[17];
  ...
  /*    16 */  /* [R_BswmRule_BatteryLow, MRP_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode] */
...
FUNC(void, BSWM_CODE) BswM_Init_Gen(void)
{
  ...
  BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode = RTE_MODE_MdgBswMBatteryMode_BSWM_BATTERY_MEDIUM;
  BswM_PduGroupControlInvocation = BSWM_GROUPCONTROL_IDLE;
...
FUNC(void, BSWM_CODE) BswM_SwcModeRequestUpdateFct(void)
{
  ...
  mode = Rte_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode();
  if (mode != RTE_TRANSITION_MdgBswMBatteryMode)
  {
    BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode = (Rte_ModeType_MdgBswMBatteryMode)mode;
  }
...
/**********************************************************************************************************************
 *  BswM_ActionList_BswMActionList_BatteryLow_True
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_BswMActionList_BatteryLow_True(void)
{
  (void)ComM_RequestComMode(ComMConf_ComMUser_USR_CHNL_CAN00, COMM_FULL_COMMUNICATION);
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
/**********************************************************************************************************************
 *  BswM_Rule_BswmRule_BatteryLow
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_BswmRule_BatteryLow(void)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST;
  /* Evaluate logical expression CleBatteyModeLow. */
  if(BswM_Mode_Notification_SWC_MODE_NOTIFICATION_BswM_MDGP_MdgBswMBatteryMode_BswM_MDGP_MdgBswMBatteryMode == RTE_MODE_MdgBswMBatteryMode_BSWM_BATTERY_LOW)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_BswmRule_BatteryLow) != BSWM_TRUE )
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_BswmRule_BatteryLow, BSWM_TRUE);
      /* Return triggered action list BswM_ActionList_BswMActionList_BatteryLow_True. */
      retVal = BSWM_ID_AL_BswMActionList_BatteryLow_True;
    }
  }
  else
  {
    BswM_UpdateRuleStates(BSWM_ID_RULE_BswmRule_BatteryLow, BSWM_FALSE);
    /* No false action list configured. */
  }
  return retVal;
}
